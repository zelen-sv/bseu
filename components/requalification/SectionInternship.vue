<template>
  <div class="content-section">
    ...
    <p class="content-section__list-text">{{ $t("pages.requalification.section-internship.dot_text_2") }}</p>
    <p>{{ $t("pages.requalification.section-internship.description_p3") }}</p>
  </div>
</template>
