<template>
  <div class="visa-documents">
    <div class="documents-list__description">
      ...
      <p v-html="$t('pages.first-higher.admission-documents.description-no-visa')"></p>
    ...
    <div class="documents-list__sections">
      ...
      <div class="documents-list__section">
        ...
        <div class="documents-list__section-data">
          <div class="documents-list__section-title">
            {{ $t("pages.first-higher.admission-documents.passport-copy") }}
          </div>
          <div class="documents-list__section-common">
            {{ $t("pages.first-higher.admission-documents.passport-info") }}
          </div>
          <div class="documents-list__section-item">
            -{{ $t("pages.first-higher.admission-documents.passport-fullname") }}
          </div>
          <div class="documents-list__section-item">
            -{{ $t("pages.first-higher.admission-documents.passport-number") }}
          </div>
          <div class="documents-list__section-item">
            -{{ $t("pages.first-higher.admission-documents.passport-term") }}
          </div>
          <div class="documents-list__section-item">
            -{{ $t("pages.first-higher.admission-documents.passport-country") }}
          </div>
          <div class="documents-list__section-item documents-list__section-item_selected">
            + {{ $t("pages.first-higher.admission-documents.passport-translate") }}
          </div>
        </div>
      </div>
      ...
      <div class="documents-list__section">
        ...
        <div class="documents-list__section-data">
          <div class="documents-list__section-title">
            {{ $t("pages.first-higher.admission-documents.education-documents-copy") }}
          </div>
          <div class="documents-list__section-common">
            {{ $t("pages.first-higher.admission-documents.education-documents-info") }}
          </div>
          <div class="documents-list__section-item documents-list__section-item_selected">
            + {{ $t("pages.first-higher.admission-documents.education-documents-translate") }}
          </div>
        </div>
      </div>
