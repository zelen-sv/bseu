...
export default {
  "pages": {
    ...
    "second-higher": {
      ...
      "bseu-section": {
        "legend": "BDYU-da ikinji ýokary bilim",
    ...
    "training-and-courses": {
      "sidebar": {
        ...
        "courses-russian": "Rus dili kursy"
      },
      "training-section": {
        "legend": "Taýýarlyk bölümi",
      ...
      "training-cost-data": {
        "legend": "Okuwyň tölegi (2018-2019)",
        "form-text": "Töleg görnüşi – tapgyrlaýyn, okuw töleginiň bahasynyň 50% möçberinde:",
        "stage-1": "1-nji tapgyr – 1-nji oktýabra çenli",
        "stage-2": "2-nji tapgyr – 1-nji fewraldan 1-nji marta çenli.",
    ...
    "about-university": {
      "sidebar": {
        "bseu-section": "BDYU",
        "hostel-section": "Umumy ýaşaýyş jaýy",
        "sport-center-section": "Sport kompleksi",
        "student-life-section": "Talyp durmuşy"
      },
      "bseu-section": {
        "legend": "Belarus döwlet ykdysadyýet uniwersiteti",
        "description_p1": "BDYU-ne girmek karary, daşary ýurt raýatlary üçin hemme tarapdan bähbitli netije berer. Bu ýokary okuw jaýy Belarusyň öňde barýan ylmy-tejribe merkezi bolup durýar. Bu ýerde özleşdirilýän hünärler döwür bilen laýyk gelýär we bu ýokary okuw jaýyny gutaran talyplar öz ýurtlarynda talap edilýän hünärmenler bolýarlar. 1-nji basgançak çäklerinde alnan Belarus ykdysadyýet bilimi daşary ýurtlaryň köpüsinden abraýdan peýdalanýar, uniwersitetiň özi bolsa profil sanawnamalarynda hemişe ýokary derejeleri eýeleýär.",
      ...
      "hostel-section": {
        ...
        "description_p1": "Talyp şäherçesi 8 umumy ýaşaýyş jaýyny öz içine alýar, olardan biri daşary ýurtdan gelen talyplar, aspirantlar, taýýarlyk kursy we rus dili kurslarynyň diňleýjileri üçin taýýarlanandyr.",
        "description_p2": "Uniwersitetiň umumy ýaşaýyş jaýlarynda sportyň 8 görnüşi boýunça – atletizm, OFP, gözellik, mini-futbol, ýoga, billiard, stol tennisi, darts - 31 sport bölümi bar, olarda 662 adam sport bilen meşgullanýar.",
        "description_p3": "Döwrebap we rahat ýaşaýyş şertlerini “iň gowy ýaşaýyş jaýy” ýaryş synlarynda ençeme gezek alnan ýeňişler hem tassyklaýar."
      },
      "sport-center-section": {
        "legend": "Sport kompleksi",
        "dot_text_1": "• Sportuň oýun görnüşleri (woleýbol, basketbol) üçin çalt özgerdip bolýan zal;",
        "dot_text_2": "• Döwrebap gurallar bilen enjamlaşdyrylan türgenleşik zaly;",
        "dot_text_3": "• Gerekli sport inwentarlary we gurluşlary bilen üpjün edilen aerobika zaly;",
        "dot_text_4": "• Ýüzmek üçin howuz, 4 ýoldan ybarat (25m. * 11m., pes ýeri – 180 sm., çuň ýeri – 220 sm.).",
        "description_p1": "BDYU-nyň sport kompleksi 2006-njy ýylyň 30-njy dekabrynda ulanylmaga berildi we uniwersitetiň gurluş bölümçesi bolup durýar.",
        "description_p2": "Sport bazasy şulary içine alýar:",
        "description_p3": "Sport kompleksiniň işgärleriniň arasynda, toparlaýyn ýa-da ýekelikde türgenleşik üçin gelenleri howpsuz türgenleşik hem isleg bildirýänleri degişli maslahatlar bilen üpjün edýän tejribeli lukmanlar, usulnamaçy-instruktorlar hem bar."
      },
      "student-life-section": {
        "legend": "Talyp durmuşy",
        "description_p1": "BDYU talyp kluby zehinli işgärleriň we ýiti talyplaryň köp ýyllyk konglomeratydyr. Klubyň esasy işleri talyplaryň çeperçilik döredijiliginiň ösdürilmegine, ýaşlaryň ruhy taýdan terbiýelenmeginiň ahlak derejesiniň ýokarlandyrylmagyna, respublikamyzyň medeniýet däpleriniň gollanmagyna we hoşniýetlilik we döredijilik gurşawynyň emele getirilmegine gönükdirilendir.",
        "description_p2": "Soňky 5 ýylyň dowamynda talyp klubunyň kollektiwleri ‘Suzor-e’ halk döredijilik festiwalyna, ‘Zolotoýa lira’ watansöýerlik aýdymlarynyň we wokallarynyň şäher ýaryşlarynda, respublikan ‘Art-wakatsyý’, ‘Zorka uzyşla nad Belarussýu’ we ‘Nowyýe imena Belarusi’ festiwal ýaryşynda, ‘Paparats kwetka’ hor toparlarynyň halkara ýaryşynda we ‘My wmeste’ atly höwesjeňler döredijiligine gatnaşdyrlar.",
        "description_p3": "Çeperçilik höwesjeňleri toparlary şeflik we haýyr-sahabat konsertlerine, spektakllara, etrapş şäher, respublikan medeni-köpçülik çärelerine hem gatnaşýarlar. Toparlaryň ýyllyk hasabat konsertleri däbe öwrülip gitdi. Horeografika toparlary respublikan ýaýlym “Soberi Belarus w swoýem serdse” programmasyna hem gatnaşdylar. Halk aýdymy ansambly ‘Gorlitsa’ – ‘Weçary u Mirskim zamku’ telewideiniýe taslamasyna we milli ýaryş ‘Miss Belarusa’ gatnaşdylar.",
        "description_p4": "Talyplyk klubunyň işjeň gatnaşmagynda we kömegi bilen, uniwersitetde talyp döredijilik taslamalary işjeň ösüşine dowam edýär: ‘Ýylyň talyby’ ýaryşy, ‘Osenniý marafon’ iň gowy tematik programma festiwaly, ‘Wiwat perwokursnik!’ ýaryşy, ‘Miss BDYU’ gözellik we çeper ussatlyk ýaryşy, ‘BDYU talyp ýazy’ çeper döredijilik festiwaly."
      }
    },
    "bseu-application": {
      "application-header": {
    ...
    "requalification": {
      "sidebar": {
        ...
        "refresher-training": "Kwalifikasiýa ýokarlandyrma",
        "internship": "Stažirowka"
      },
      "section-requalification": {
        "legend": "Kämilleşdirme",
        ...
        "icon-1": "Ýokary bilim esasynda",
        "icon-2": "Halkara görnüşli diplom",
        "icon-3": "Okuw möhleti 18-24 aý",
        "icon-4": "Okuwyň gaýybana görnüşi"
      },
      ...
      "section-refresher-training": {
        "legend": "Kwalifikasiýa ýokarlandyrma",
  ...
  "components": {
    ...
    "documents-list": {
      "admission-documents": {
        "legend": "Giriş üçin gerekli resminamalar",
        "visa": "WIZA GEREK",
        ...
        "application-document-2": "hünärmenlik",
        "application-document-3": "okuw görnüşi (gündizki, gaýybana)",
        "application-document-4": "doly poçta salgysy",
        "application-document-5": "elektron poçta salgysy ýa-da faks belgisi",
        "passport-copy": "Pasportyň şu şahsy maglumatlary",
        "passport-info": "içine alýan sahypalarynyň nusgalary:",
        "passport-fullname": "latyn harplary bilen doly ady",
        "passport-number": "pasport belgisi",
        "passport-term": "pasportyň möhleti",
        "passport-country": "pasporty beren döwlet",
        "passport-translate": "nusgalaryň rus diline geçirilen tassyklanan terjimesi",
        "education-documents-copy": "Bilimi hakynda resminamalaryň nusgalary",
        "education-documents-info": "(doly orta, ýokary)",
        "education-documents-translate": "nusgalaryň rus diline geçirilen tassyklanan terjimesi"
      },
      "arriving-documents": {
        "legend": "Gelen wagtyňyzda getirmeli resminamalaryňyz",
        "original-invitation": "Оригинал приглашения",
        "original-education-document": "Bilimi hakynda resminamanyň esasy nusgasy",
        "original-education-document-translate": "nusganyň rus diline geçirilen tassyklanan terjimesi, şol sanda öwrenilen dersleriň hem alnan bahalaryň (utuklaryň) görkezilmegi bilen",
        "original-birth-certificate": "Dogluş şahadatnamasynyň esasy nusgasy",
        "original-birth-certificate-copy": "kepillendiriş edarasy tarapyndan tasyyklanan nusgasy",
        "medical-certificate": "Saglyk ýagdaýy hakynda lukmançylyk kepilnamasy",
        "medical-certificate-vich": "WIÇ, gepatit, tuberkulýoz keselleriniň ýoklugy barada",
        "medical-certificate-ebola": "отсутствие вируса Эбола (для африканских абитуриентов)",
        "medical-certificate-climat": "Belarus Respublikasynyň howa şertlerinde ýaşamak mümkinçiligi barada",
        "medical-certificate-translate": "kepilnamanyň rus diline terjimesiniň kepillendiriş edarasy tarapyndan tassyklanan nusgasy",
        "passport-study-visa": "Belarus Respublikasyna giriş üçin okuw wizasy bolan pasport",
        "fotos": "10 sany surat (3*4 sm)"
      },
    },
    "visa-admission-scheme": {
      "first-step": "Web sahypamyzda talaplyk (zaýawka) ýerleşdiriň biz siz bilen habarlaşarys.",
      "second-step": "Bize gerekli resminamalaryň nusgalaryny ugradyň",
      "third-step": "Biz çakylyk taýýarlaýarys we ilçihana ugradýarys",
      "fourth-step": "Siz wiza alýarsyňyz we petekleri satyn alýarsyňyz!",
      "details": "* bize geljek wagtyňyzy habar beriň we biz, gerekli bolsa sizi howa menzilinde garşylarys"
    },
    "no-visa-admission-scheme": {
      "first-step": "Web sahypamyzda talaplyk (zaýawka) ýerleşdiriň biz siz bilen habarlaşarys",
      "second-step": "Biz çakylyk taýýarlaýarys we ilçihana ugradýarys",
      "third-step": "Siz wiza alýarsyňyz we petekleri satyn alýarsyňyz!",
      "details": "* bize geljek wagtyňyzy habar beriň we biz, gerekli bolsa sizi howa menzilinde garşylarys"
    },
    "date-picker": {
      "monthes": monthes,
