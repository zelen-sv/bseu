export default [
  ...
  },
  {
    ...
    description: "Правила поступления в БГЭУ указаны на официальном сайте университета. Первое, что определяет приемная комиссия – уровень владения иностранным гражданином языком обучения. Это важный момент, поскольку обучение на первой ступени высшего образования осуществляется в БГЭУ только на русском языке, на второй ступени (в магистратуре) и аспирантуре – на русском или английском языках. По результатам собеседования и изучения представленных в приемную комиссию документов принимается решение о зачислении.",
    active: false
  },
  {
